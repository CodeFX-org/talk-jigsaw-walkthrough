...
<div class="event">
	...
	<div class="participant">
		<img src="images/logo-objektforum-ka.png" class="logo" style="padding: 0; height: 70px; background-color: transparent !important; border-color: transparent;">
		<div class="name">
			<p><a href="https://www.andrena.de/objektforum">Objektforum</a></p>
			<p><a href="https://twitter.com/objektforum" title="Objektforum on Twitter">@objektforum</a></p>
		</div>
	</div>
</div>
++++
...
<footer>
	...
	<div class="participant">
		<img src="images/logo-objektforum-ka.png" class="logo" style="padding: 0; height: 30px; background-color: transparent !important; border-color: transparent;">
		<div class="name"><p>
			<a href="https://www.andrena.de/objektforum">Objektforum</a> /
				<a href="https://twitter.com/objektforum" title="Objektforum on Twitter">@objektforum</a>
		</p></div>
	</div>
</footer>
<script>
