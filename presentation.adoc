...
* some libraries split `javax.xml.*`, e.g. http://search.maven.org/#artifactdetails|xml-apis|xml-apis|2.0.2|jar[xml-apis]
* http://mvnrepository.com/artifact/com.google.code.findbugs/jsr305[FindBugs-Jsr305] splits `javax.annotation`
