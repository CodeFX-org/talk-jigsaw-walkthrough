...
<div class="event">
	...
	<div class="participant">
		<img src="images/logo-javaforumnord.png" class="logo">
		<div class="name">
			<p><a href="http://javaforumnord.de">Java Forum Nord</a></p>
			<p><a href="https://twitter.com/javaforumnord" title="Java Forum Nord on Twitter">@javaforumnord</a></p>
		</div>
	</div>
</div>
++++
...
<footer>
	...
	<div class="participant">
		<img src="images/logo-javaforumnord.png" class="logo">
		<div class="name"><p>
			<a href="http://javaforumnord.de">Java Forum Nord</a> /
				<a href="https://twitter.com/javaforumnord" title="Java Forum Nord on Twitter">@javaforumnord</a>
		</p></div>
	</div>
</footer>
<script>
